...
export const execEIP1559ContractByNonce = (web3, chainId, priKey, sendEncodeABI, value, contractAddress, nonce, onTransactionHashFun, onConfirmedFunc, onReceiptFunc, onErrorFunc) => {
	const senderAddress = (web3.eth.accounts.privateKeyToAccount('0x' + priKey)).address;
	// console.log(senderAddress);
